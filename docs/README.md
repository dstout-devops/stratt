...
| **[enterprise-readiness.md](enterprise-readiness.md)**                 | The hardening sibling of the roadmap — a living, evidence-backed inventory of the gaps between what Stratt _claims_ and what it _enforces in the shipped artifact_.                                                                                                                                                   |
| **[demos/](../demos/README.md)**                                       | The demo library (ADR-0116) — self-contained, narrated, turnkey scenarios that teach Stratt by running it. Start: **[k8s: deploy an app](../demos/k8s-deploy/README.md)**. Getting-started / onboarding material.                                                                                                     |
