...
- **P2 · `/api/v2` route breadth** — ~~`workflow_job_templates`~~ (done 2026-07-31, with `workflow_jobs`),
  ~~`schedules`~~ (done 2026-07-31), `projects`, `credentials` so existing AWX/AAP tooling survives cutover
  (the strangler-fig front door, §7.6).
