...
// GetManifest advertises the SYNCER class + the five `ansible.*` Facet namespaces this
...
func (s *Server) GetManifest(context.Context, *pluginv1.GetManifestRequest) (*pluginv1.GetManifestResponse, error) {
	kinds := []string{KindPlaybook, KindRole, KindCollection, KindInventory, KindVarScope}
